...
import (
	...
	internalRest "kontroler-controller/internal/server/rest"
	"kontroler-controller/internal/server/ws"
	"net"
	"net/http"
	"os"
	"os/signal"
...
func main() {
	...
	// Ensure auth manager resources are cleaned up when main exits
