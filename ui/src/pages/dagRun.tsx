          ...
          {selectedTask() === -1 ? (
            ...
            taskDetails() && (
              <div class="mt-6  p-4 rounded-lg border border-gray-200">
                ...
                <p class="mb-1"><strong>ID:</strong> {taskDetails()?.id}</p>
                <p class="mb-1"><strong>Status:</strong> {taskDetails()?.status}</p>
                <p class="mb-1"><strong>Attempts:</strong> {taskDetails()?.attempts}</p>
                  ...
                  {taskDetails()?.pods.map((pod) => (
                    <li class="mb-2">
                      <div class="ml-4 border-gray-200 p-4 rounded-lg border">
                        ...
                        <p><strong>Exit Code:</strong> {pod.exitCode}</p>
                      </div>
                    </li>
                  ))}
                </ul>
